...
probs <- readRDS(file.path(dir, "probabilities.Rdata"))
haploCounts <- data.table::fread("/home/maryam/research/hackathons/C7_3rd_July/biAllelic_llr4_100kb_fixed_many_haplotaggedCounts.txt")
